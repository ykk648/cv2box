...
try:
    ...
    # print('Use default multi mode: multi-thread, or you can set env \'CV_MULTI_MODE\' to multi-process/torch-process')
...
from .cv_threads_base import Factory, Linker, Consumer, Queue, Manager, Process, Event, Lock, QueueMonitor
